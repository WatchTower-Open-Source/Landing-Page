...
export var cleanLeadingZerosInNumericSectionValue = function cleanLeadingZerosInNumericSectionValue(utils, format, value) {
...
export var adjustSectionValue = function adjustSectionValue(utils, section, keyCode, sectionsValueBoundaries, activeDate) {
  ...
  var cleanDigitSectionValue = function cleanDigitSectionValue(value) {
  ...
  var adjustDigitSection = function adjustDigitSection() {
    ...
    var currentSectionValue = Number(section.value);
...
export var doesSectionHaveTrailingZeros = function doesSectionHaveTrailingZeros(utils, contentType, sectionType, format) {
...
export var splitFormatIntoSections = function splitFormatIntoSections(utils, localeText, format, date) {
  ...
  var commitToken = function commitToken(token) {
    ...
    var hasTrailingZeroes = doesSectionHaveTrailingZeros(utils, sectionConfig.contentType, sectionConfig.type, token);
