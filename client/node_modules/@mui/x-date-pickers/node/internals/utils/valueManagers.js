...
const singleItemFieldValueManager = {
  ...
  getSectionsFromValue: (utils, localeText, prevSections, date, format) => (0, _useField.addPositionPropertiesToSections)((0, _useField.splitFormatIntoSections)(utils, localeText, format, date)),
