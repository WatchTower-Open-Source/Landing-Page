  ...
  const applyNumericEditing = params => {
    const getNewSectionValue = (queryValue, sectionType, format, hasTrailingZeroes, contentType) => {
      ...
      if (hasTrailingZeroes) {
        newSectionValue = (0, _useField.cleanLeadingZerosInNumericSectionValue)(utils, format, newSectionValue);
      }
      return {
    ...
    const getFirstSectionValueMatchingWithQuery = (queryValue, activeSection) => {
      ...
      if (activeSection.type === 'month') {
        const response = getNewSectionValue(queryValue, activeSection.type, 'MM', (0, _useField.doesSectionHaveTrailingZeros)(utils, 'digit', 'month', 'MM'), 'digit');
        if (isQueryResponseWithoutValue(response)) {
          return response;
        }
